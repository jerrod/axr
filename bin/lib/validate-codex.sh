...
# _check_codex_staleness — verify codex/plugins/<name>/ exists, has a build-stamp,
# and that no source files have been committed since the stamp was committed.
_check_codex_staleness() {
    ...
    local stale=false stamp_commit source_changes
